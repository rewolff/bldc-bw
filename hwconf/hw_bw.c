...
void hw_setup_adc_channels(void) {
	...
	ADC_RegularChannelConfig(ADC1, ADC_Channel_6, 2, ADC_SampleTime_15Cycles); // 3
	...
	ADC_RegularChannelConfig(ADC2, ADC_Channel_5, 2, ADC_SampleTime_15Cycles); // 4
	...
	ADC_RegularChannelConfig(ADC3, ADC_Channel_12, 3, ADC_SampleTime_15Cycles); // 8
